...
class AdminController extends Controller
{
    ...
    public function dashboard(){
        ...
        $latestReservations = Reservation::where('guest_number', '>', 0)->limit(5)->orderBy('created_at', 'desc')->get();
    ...
    public function dailyRevenueLast30(){
        ...
        //         (sum(guest_number) * 27 ) as estimated_earnings, 
