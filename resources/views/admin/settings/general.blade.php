                                ...
                                <div class="card-body">
                                    <form method="POST" action="/admin/settings/general">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputSiteTitle" type="text" class="form-control form-control-lg @error('site_title') is-invalid @enderror" name="site_title" value="{{ old('site_title', $general_setting->site_title) }}" required autocomplete="site_title" autofocus placeholder="Add Site Title">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputazipcode" type="text" class="form-control form-control-lg @error('zipcode') is-invalid @enderror" name="zipcode" value="{{ old('zipcode', $general_setting->zip) }}" required autocomplete="zipcode" autofocus placeholder="">
