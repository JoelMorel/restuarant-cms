            ...
            <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <div id="submenu-2" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="pages/cards.html">Catergories <span class="badge badge-secondary">New</span></a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="submenu-3" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="pages/cards.html">Notifications <span class="badge badge-secondary">New</span></a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div id="submenu-4" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/admin/users/create">Create New User<span class="badge badge-secondary">New</span></a>
                            </li>
